...
scanf("%s", cad5);
/* La funcion scanf, con el formato de variable %s, también se puede utilizar
 para leer una cadena de caracteres, aunque con algunas restricciones. Si la
 cadena está formada por varias palabras solo lee la primera. Por ejemplo, si
 queremos ingresar la cadena "Buenos dias", sólo lee la palabra "Buenos", por
 ello esta función únicamente es útil si conocemos con anticipacion que la
